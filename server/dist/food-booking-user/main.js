...
class AuthService {
    constructor(http) {
        this.http = http;
        this.signUpUrl = '/userAuth/signUp';
        this.loginUrl = '/userAuth/logIn';
    }
    signUp(form) {
        console.log(form);
    ...
    getUser() {
        return this.http.get('/userAuth/getUser');
    }
    getToken() {
        return localStorage.getItem('token');
    }
    getOrdersByUserId(id) {
        return this.http.get('/order/getOrdersByUserId/' + id);
    }
}
...
class FoodService {
    constructor(http) {
        this.http = http;
        this.getAllCatUrl = '/foods/getAllCat';
        this.getFoodsByCatIdUrl = '/foods/getFoodsByCatId/';
    }
    getAllCat() {
    ...
    getImage(id) {
        return this.http.get('/files/getImage/' + id);
    }
    getFoodById(fid) {
        return this.http.get('/foods/getFoodById/' + fid);
    }
    placeOrder(order) {
        return this.http.post('/order/placeOrder', order);
    }
}
